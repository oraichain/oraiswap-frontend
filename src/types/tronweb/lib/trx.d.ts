export default class Trx {
    ...
    verifyMessage(message?: boolean, signature?: boolean, address?: any, useTronHeader?: boolean, callback?: boolean): Promise<any>;
    verifyMessageV2(message?: boolean, signature?: boolean, options?: {}, callback?: boolean): any;
    ...
    sendRawTransaction(signedTransaction?: boolean, options?: {}, callback?: boolean): any;
    sendHexTransaction(signedHexTransaction?: boolean, options?: {}, callback?: boolean): any;
    sendTransaction(to?: boolean, amount?: boolean, options?: {}, callback?: boolean): Promise<any>;
    sendToken(to?: boolean, amount?: boolean, tokenID?: boolean, options?: {}, callback?: boolean): Promise<any>;
    /**
     ...
     * @param callback
     */
    freezeBalance(amount?: number, duration?: number, resource?: string, options?: {}, receiverAddress?: any, callback?: boolean): Promise<any>;
    /**
     ...
     */
    getDelegatedResourceV2(fromAddress?: any, toAddress?: any, options?: {
        confirmed: boolean;
    }, callback?: boolean): any;
    /**
     * Query the resource delegation index by an account
     */
    getDelegatedResourceAccountIndexV2(address?: any, options?: {
        confirmed: boolean;
    }, callback?: boolean): any;
    /**
     * Query the amount of delegatable resources of the specified resource Type for target address, unit is sun.
     */
    getCanDelegatedMaxSize(address?: any, resource?: string, options?: {
        confirmed: boolean;
    }, callback?: boolean): any;
    /**
     * Remaining times of available unstaking API
     */
    getAvailableUnfreezeCount(address?: any, options?: {
        confirmed: boolean;
    }, callback?: boolean): any;
    /**
     * Query the withdrawable balance at the specified timestamp
     */
    getCanWithdrawUnfreezeAmount(address?: any, timestamp?: number, options?: {
        confirmed: boolean;
    }, callback?: boolean): any;
    /**
     * Get the exchange ID.

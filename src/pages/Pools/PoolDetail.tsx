        ...
        <div className={cx('pool-detail')}>
          <div className={cx('header')}>
            <div className={cx('logo')}>
              <img className={cx('token1')} src={require(`assets/icons/${mockToken[token1].logo}`).default} />
              <img className={cx('token2')} src={require(`assets/icons/${mockToken[token2].logo}`).default} />
            ...
            <div className={cx('btn', 'liquidity')}>Add/Remove Liquidity</div>
          </div>
          <div className={cx('info')}>
            <div className={cx('container')}>
              <div className={cx('title')}>Total Amount</div>
              <div className={cx('row')}>
                <img className={cx('logo')} src={require(`assets/icons/${mockToken[token1].logo}`).default} />
                <div>{token1}</div>
              ...
              <div className={cx('row')}>
                <img className={cx('logo')} src={require(`assets/icons/${mockToken[token2].logo}`).default} />
                <div>{token2}</div>
                <div className={cx('amount')}>
                  <div>103,980.23</div>
                  <div className={cx('value')}>$2,644,521</div>

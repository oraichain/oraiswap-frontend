        ...
        'totalLiquidity': {
            ...
            accessor: (data) =>
                <div className={styles.liquidity}>
                    <span style={{ marginRight: 15 }}>{formatDisplayUsdt(toDisplay(parseInt(data.totalLiquidity.toString()).toString()))}</span>
                    <Button type='primary-sm' onClick={() => console.log('ok')}>Add</Button>
                </div>
        }
    }
        ...
        <div className={styles.listpools}>
            ...
            <div className={styles.listpools_list}>
                {filteredPairInfos.length > 0 ? (
                    <Table headers={headers} data={pools} handleClickRow={handleClickRow} />
                ) : (

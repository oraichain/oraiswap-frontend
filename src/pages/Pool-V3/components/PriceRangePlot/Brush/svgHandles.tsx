...
export const LeftHandle: React.FC<Pick<ISVGHandle, 'height' | 'fill'>> = ({ height = 0, fill }) => (
  <>
    ...
    <path d="M5 5V15" stroke="#efefef" strokeOpacity="0.5" />
    <path d="M8 5V15" stroke="#efefef" strokeOpacity="0.5" />
  </>
);

export const RightHandle: React.FC<Pick<ISVGHandle, 'height' | 'fill'>> = ({ height = 0, fill }) => (
  <>
    ...
    <path d="M29 5V15" stroke="#efefef" strokeOpacity="0.5" />
    <path d="M32 5V15" stroke="#efefef" strokeOpacity="0.5" />
  </>
);
...
export const MaxHandle: React.FC<ISVGHandle> = ({ height, className, x, fill, textColor, isReversed = false }) => (
  <svg
    ...
    x={x}
  >
    {!isReversed ? <RightHandle height={height} fill={fill} /> : <LeftHandle height={height} fill={fill} />}
...
export const MinHandle: React.FC<ISVGHandle> = ({ height, className, x, fill, textColor, isReversed = false }) => (
  <svg
    ...
    x={x}
  >
    {!isReversed ? <LeftHandle height={height} fill={fill} /> : <RightHandle height={height} fill={fill} />}

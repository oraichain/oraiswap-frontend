...
import { TitleText, Text } from 'components/Texts';
import { PoolCardList } from 'pages/pools/components/PoolCardList';
import { IncentivizedPoolCardProp } from 'pages/pools/models/poolCardProps';
...
export const IncentivizedPools: FunctionComponent = () => {
  ...
  const incentivizedPoolInfoList = [];
    ...
    <div>
      ...
      {incentivizedPoolInfoList.length === 0 ? (
        <NoActiveCard>
          ...
          <Text weight="medium">
            Liquidity mining will begin once the first update pool incentives

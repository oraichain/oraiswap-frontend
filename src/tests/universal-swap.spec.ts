...
describe('universal-swap', () => {
  ...
  describe('test-processUniversalSwap-with-mock', () => {
    ...
    it.each([
      [
        'from-Oraichain-to-cosmos-hub',
        oraichainTokens.find((t) => t.coinGeckoId === 'cosmos'),
        cosmosTokens.find((t) => t.coinGeckoId === 'cosmos' && t.chainId === 'cosmoshub-4'),
        cosmosTokens.find((t) => t.coinGeckoId === 'cosmos' && t.chainId === 'cosmoshub-4')
      ],
      [
        'from-Oraichain-to-osmosis',
        oraichainTokens.find((t) => t.coinGeckoId === 'osmosis'),
        cosmosTokens.find((t) => t.coinGeckoId === 'osmosis' && t.chainId === 'osmosis-1'),
        cosmosTokens.find((t) => t.coinGeckoId === 'osmosis' && t.chainId === 'osmosis-1')
      ],
      [
        'from-Oraichain-to-evm-network-is-bsc',
        oraichainTokens.find((t) => t.coinGeckoId === 'airight'),
        evmTokens.find((t) => t.coinGeckoId === 'airight' && t.chainId === '0x38'),
        cosmosTokens.find((t) => t.coinGeckoId === 'airight' && t.chainId === 'oraibridge-subnet-2')
      ],
      [
        'from-Oraichain-to-evm-network-is-eth',
        oraichainTokens.find((t) => t.coinGeckoId === 'usd-coin'),
        evmTokens.find((t) => t.coinGeckoId === 'usd-coin' && t.chainId === '0x01'),
        cosmosTokens.find((t) => t.coinGeckoId === 'usd-coin' && t.chainId === 'oraibridge-subnet-2')
      ],
      [
        'from-Oraichain-to-evm-network-is-tron',
        oraichainTokens.find((t) => t.coinGeckoId === 'tron'),
        evmTokens.find((t) => t.coinGeckoId === 'tron' && t.chainId === '0x2b6653dc'),
        cosmosTokens.find((t) => t.coinGeckoId === 'tron' && t.chainId === 'oraibridge-subnet-2')
      ]
    ])('test-findToToken-when-universalSwap-%s', (_name, fromToken, toToken, expectedToTokenTransfer) => {
      const toTokenTransfer = findToToken(fromToken, toToken.chainId);
      expect(toTokenTransfer).toEqual(expectedToTokenTransfer);
    });

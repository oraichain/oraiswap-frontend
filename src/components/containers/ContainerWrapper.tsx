...
export const ContainerWrapper: FunctionComponent<TContainerWrapperProps> = ({
  ...
  const updateState = React.useCallback(
    (containerState: IContainerState, bool: boolean) => {
...
const applyState = (totalState: boolean[]) => {
  ...
  else if (totalState[IContainerState.SELECTED])
    return IContainerState.SELECTED;
...
const ContainerOverlay: FunctionComponent<TContainerOverlayProps> = ({
  state,
  className
}) => {

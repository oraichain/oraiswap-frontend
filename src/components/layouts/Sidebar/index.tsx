    ...
    <React.Fragment>
            ...
            <div className="w-full h-full p-5 md:py-6 flex flex-col justify-between">
              <div>
                <section className="mb-15 flex flex-row items-center">
                  <div className="flex items-center">
                    <img
                      ...
                      src="/assets/main/osmosis-logo-main.svg"
                      alt="osmosis logo"
                ...
                <section>
                  {mapKeyValues(
                    LAYOUT.SIDEBAR,
                    (_: string, sidebarItem: TSIDEBAR_ITEM) => sidebarItem
                  )
                    .filter((sidebarItem) => {
                      if (
                        isMobileView &&
                        (sidebarItem.TEXT === 'Stake' ||
                          sidebarItem.TEXT === 'Vote')
                      ) {
                        return false;
                      }
                      return true;
                    ...
                    .map((sidebarItem) => (
                      <SidebarItem
                        ...
                        selected={pathnameCheck(
                          pathname,
                          sidebarItem.SELECTED_CHECK
                        )}
      ...
      >
        ...
        <img
          ...
          src={`/assets/Icons/${isOpenSidebar ? 'Close' : 'Menu'}.svg`}
          alt="hamburger menu"

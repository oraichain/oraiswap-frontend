...
export const SidebarItem: FunctionComponent<TSidebarItem> = ({
  sidebarItem,
  selected,
  closeSidebar
}) => {
      ...
      >
        <div className="h-11 w-11 relative">
          <img
            ...
            src={
              selected
                ? '/assets/sidebar/icon-border_selected.svg'
                : '/assets/sidebar/icon-border_unselected.svg'
            }
          />
          <img
        ...
        {sidebarItem.LINK ? (
          <img
            className="ml-2"
            src="/assets/sidebar/icon-link-deco.svg"
            alt="link"
          />
        ) : null}
      </li>

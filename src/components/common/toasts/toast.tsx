...
const CloseButton: FunctionComponent<{ closeToast: () => void }> = ({
  closeToast
}) => (
  <button
    onClick={closeToast}
  ...
  >
    <img alt="x" className="w-full h-full" src="/assets/Icons/ToastClose.png" />
  </button>
);
...
const ToastTxBroadcasting: FunctionComponent = () => (
  <div className="flex gap-3 md:gap-3.75">
    <img alt="ldg" className="s-spin w-7 h-7" src="/assets/Icons/Loading.png" />
...
const ToastTxFailed: FunctionComponent<{ message: string }> = ({ message }) => (
  <div className="flex gap-3 md:gap-3.75">
    <img className="w-8 h-8" alt="x" src="/assets/Icons/FailedTx.png" />
    <section className="text-white-high">
...
const ToastTxSuccess: FunctionComponent<{ link: string }> = ({ link }) => (
  <div className="flex gap-3 md:gap-3.75">
    <img className="w-8 h-8" alt="b" src="/assets/Icons/ToastSuccess.png" />
    <section className="text-white-high">

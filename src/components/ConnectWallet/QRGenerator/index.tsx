...
const QRGeneratorModal: React.FC<QRGeneratorProps & QRGeneratorInfo> = ({
    url,
    name,
    icon,
    address,
        ...
        >
            <div className={cx('QR_generator_modal_wrapper')}>
                <div className={cx('header')}>
                    <div>QR Code</div>
                    <div onClick={close} className={cx('close-icon')}><CloseIcon /></div>
                </div>
                ...
                <div className={cx('cancel-btn')} onClick={close}>Cancel</div>
            </div>
        </Modal>
    );
};

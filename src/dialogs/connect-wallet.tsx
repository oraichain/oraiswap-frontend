...
const walletList = [
  {
    ...
    logoUrl: '/assets/other-logos/keplr.png',
    type: 'extension'
  },
  {
    name: 'WalletConnect',
    description: 'Keplr Mobile',
    logoUrl: '/assets/other-logos/wallet-connect.png',
    type: 'wallet-connect'
  }
];
...
export class ConnectWalletManager {
    ...
    switch (request.method) {
      case 'keplr_enable_wallet_connect_v1':
        ...
        if (
          ...
          request.params[0] === this.chainStore.current.chainId
        ) {
          break;
        }
  ...
  getKeplr = (): Promise<Keplr | undefined> => {
    const connectingWalletType =
      localStorage?.getItem(KeyAutoConnectingWalletType) ||
      localStorage?.getItem(KeyConnectingWalletType);
    ...
    if (connectingWalletType === 'wallet-connect') {
      if (!this.walletConnector) {
        ...
        this.walletConnector._clientMeta = {
          ...
          icons: [window.location.origin + '/assets/osmosis-wallet-connect.png']
        };
          ...
          {walletList
            ...
            .map((wallet) => (
              ...
              >
                ...
                />
                <div>
                  <h5 className="text-base md:text-lg mb-1 text-white-high">
                    {wallet.name}
                  </h5>
                  <p className="text-xs md:text-sm text-iconDefault">
                    {wallet.description}
                  </p>
                </div>
              </button>
                ...
                <button
                  ...
                  onClick={(e) => {
                    ...
                    window.location.href =
                      'itms-apps://itunes.apple.com/app/1567851089';
                  }}
                >
  ...
  return (
    <div className="fixed inset-0 z-100 overflow-y-auto">
      <div className="p-5 flex items-center justify-center min-h-screen">
        ...
        >
          <h4 className="text-lg md:text-xl mb-3 md:mb-5 text-white-high">
            Scan QR Code
          </h4>

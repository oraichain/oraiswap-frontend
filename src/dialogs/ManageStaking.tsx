          ...
          <div className="flex items-center mb-5">
            ...
            <div className="h-full flex items-center">
              <div>
                ...
                <p>
                  Commission -{' '}
                  {applyOptionalDecimal(multiply(validator.commission, 100, 2))}
                  %
                </p>
              </div>
            </div>
...
const DisplayStake: FunctionComponent<{
  ...
  const onStake = React.useCallback(
    (input) => {
      ...
      if (gt(input, available))
        return alert('Input amount is larger than available balance');
  ...
  return (
    <>
      <div className="mb-5">
        ...
        <a
          className="text-white-mid hover:opacity-75"
          target="__blank"

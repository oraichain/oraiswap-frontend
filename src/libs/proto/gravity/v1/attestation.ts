...
export const EventObservation = {
  ...
  create<I extends Exact<DeepPartial<EventObservation>, I>>(base?: I): EventObservation {
    return EventObservation.fromPartial(base ?? {});
  },
...
export const EventInvalidSendToCosmosReceiver = {
  ...
  create<I extends Exact<DeepPartial<EventInvalidSendToCosmosReceiver>, I>>(
    base?: I,
  ): EventInvalidSendToCosmosReceiver {
    return EventInvalidSendToCosmosReceiver.fromPartial(base ?? {});
  },
...
export const EventSendToCosmos = {
  ...
  create<I extends Exact<DeepPartial<EventSendToCosmos>, I>>(base?: I): EventSendToCosmos {
    return EventSendToCosmos.fromPartial(base ?? {});
  },
...
export const EventSendToCosmosLocal = {
  ...
  create<I extends Exact<DeepPartial<EventSendToCosmosLocal>, I>>(base?: I): EventSendToCosmosLocal {
    return EventSendToCosmosLocal.fromPartial(base ?? {});
  },
...
export const EventSendToCosmosPendingIbcAutoForward = {
  ...
  create<I extends Exact<DeepPartial<EventSendToCosmosPendingIbcAutoForward>, I>>(
    base?: I,
  ): EventSendToCosmosPendingIbcAutoForward {
    return EventSendToCosmosPendingIbcAutoForward.fromPartial(base ?? {});
  },
...
export const EventSendToCosmosExecutedIbcAutoForward = {
  ...
  create<I extends Exact<DeepPartial<EventSendToCosmosExecutedIbcAutoForward>, I>>(
    base?: I,
  ): EventSendToCosmosExecutedIbcAutoForward {
    return EventSendToCosmosExecutedIbcAutoForward.fromPartial(base ?? {});
  },
